...
from search import Problem, Node, astar_search, breadth_first_tree_search, \
    depth_first_tree_search, greedy_search, depth_limited_search
import sys
import time
import copy
...
class RicochetRobots(Problem):
    ...
    def goal_test(self, state: RRState):
        print("---")
        print("R:", state.board.robot_position('R'))
        print("B:", state.board.robot_position('B'))
        print("G:", state.board.robot_position('G'))
...
if __name__ == "__main__":
    ...
    print(solution_node.state.board.robot_position('R'))
